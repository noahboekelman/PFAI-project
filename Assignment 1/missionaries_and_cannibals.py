...
class MissionariesAndCannibals:
    ...
    def state_val(self):
        return (f"{self.state[0][0]}{self.state[0][1]}{self.state[1]}{self.state[2][0]}{self.state[2][1]}")       
    ...
    def c(self): #TESTME
        ...
        right_bank=self.state[2]
        if boat=='r':
            if (right_bank[0]==0 or right_bank[0]>=right_bank[1]-1) and (right_bank[1]>=1) and (left_bank[0]>=left_bank[1]+1 or left_bank[0]==0):
                right_bank[1]-=1
                boat='l'
                left_bank[1]+=1
                self.state=[left_bank, boat, right_bank]
            ...
            if (left_bank[0]==0 or left_bank[0]>=left_bank[1]-1) and (left_bank[1]>=1) and (right_bank[0]>=right_bank[1]+1 or right_bank[0]==0):
                left_bank[1]-=1
                boat='r'
                right_bank[1]+=1
                self.state=[left_bank,boat,right_bank]
    ...
    def deb(self):
        print(f"[[{self.state[0][0]},{self.state[0][1]}],{self.state[1]},[{self.state[2][0]},{self.state[2][1]}]]")